...
type InputCoponentConstructor<T = MediaData | (TextData & Component)> = {
  new (): T;
};
class App {
  ...
  private bindElementToDialog<T extends (MediaData | TextData) & Component>(
    selector: string,
    InputComponent: InputCoponentConstructor<T>,
    makeSection: (input: T) => Component
  ) {
    const element = document.querySelector(selector)! as HTMLButtonElement; // "#new-video"
